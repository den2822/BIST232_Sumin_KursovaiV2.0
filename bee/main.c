...
void Hello();
void one(bd* info);
bd two(bd* search, char* vvod, int schet);
bd three(bd* search, char* vvod, int schet);
bd four(bd* syte, int schet);
void vivod(bd vivod);
void openfive(bd* vivod, int schet, FILE* S1);
bd six(FILE* S3);
